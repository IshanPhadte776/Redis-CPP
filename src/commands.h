...
void handle_zscore(int fd, const RespValue& req);
...
void handle_config(int fd, const RespValue& req);
void handle_acl(int fd, const RespValue& req);
void handle_auth(int fd, const RespValue& req);
